...
noise. The data needs to be processed in order for the signal to become clear.
I plan to complete this portion of the analysis for inclusion in the future shiny project.
...
h.raw <- plot_ly( pd.raw, x = ~Time ) %>%
    ...
    layout( title = 'LIGO Strain Near GW150914',
